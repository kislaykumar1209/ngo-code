...
import Button from "@material-ui/core/Button"; import React, { useEffect, useState } from "react";
...
const UpcomingHome = () => {
  ...
  const [description2, setDesc] = useState("")
  ...
  const submitButton = async (e) => {
    ...
    // console.log(description1)
    myForm.append('button1', button);

    await dispatch(updateHomeOthersInfo(myForm));
    setButton(false)
    dispatch(getHomeOthersInfo())
  };
  const submitButton2 = async (e) => {
    e.preventDefault();
    const myForm = new FormData();

    // console.log(description1)
    myForm.append('button2', button2);
  ...
  const { heading, description4, description3 } =
    extraBody;
                    ...
                    <div class="flex p-2">
                      <div class="w-full ">
                        ...
                        <div class="mb-5 flex flex-col sm:flex-row">
                          ...
                          {Button2 ? (
                            <form onSubmit={submitButton2} className="contents">
                              <div className="w-100 sm:w-full min-h-44 border-2 border-black/70 rounded-lg flex flex-col sm:flex-row">
                                <textarea
                                  rows="2"
                                  name="button2"
