...
const PartnerHome = () => {
  ...
  const activeSubmit = async (e) => {
    ...
    // console.log(value)
    const myForm = new FormData();
    let value = await title?.is_active5
    myForm.append('is_active5', !value);
    // console.log(section)
    await dispatch(updateTitleInfo(myForm, section));
    // setTopic(false)
    await dispatch(getTitleInfo(section))
  ...
  const [description1, setDesc] = useState("")
                    ...
                    <div class="flex p-2">
                      <div class="w-full ">
                        <label class="relative inline-flex items-center cursor-pointer my-8  scale-125 visibility">
                          <input type="checkbox" name='active' value={title?.is_active5 ? title.is_active5 : true} class="sr-only peer" onClick={activeSubmit} />
                         ...
                         ${!title?.is_active5 && ` bg-gray-200 after:left-[2px] peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800   dark:bg-gray-700 `}
                          ${title?.is_active5 && ` peer-checked:after:translate-x-full after:left-[20px] peer-checked:after:border-white  peer   dark:border-gray-600   peer-checked: bg-green-600`}
                        ...
                        <div class="mb-5 flex flex-col sm:flex-row">
                          ...
                          <div className="w-70  min-h-44 p-4 overflow-clip  border-2 border-gray-700 flex flex-col justify-center items-center  border-2 border-black/50 rounded-lg">
                            {image ? (
                              ...
                              (others?.image ? (<><img src={`${process.env.REACT_APP_SERVER}/${others?.image}`} /> <input
                                type="file"
                                style={{
                                  color: "transparent"
                                }}
